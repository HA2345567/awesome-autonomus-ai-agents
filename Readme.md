...
- [🚀 Multi-Agent Frameworks & Platforms](#-multi-agent-frameworks--platforms)
- [🛒 Agentic Commerce & Retail](#-agentic-commerce--retail)
...
- [🎙️ Voice & Conversational Agents](#️-voice--conversational-agents)
- [🤖 Autonomous Task Management](#-autonomous-task-management-agents)
- [🎯 Specialized Use-Case Agents](#-specialized-use-case-agents)
- [🧠 Intelligence & Research Agents](#-intelligence--research-agents)
- [🛡️ Security & Monitoring Agents](#️-security--monitoring-agents)
...
- [🔧 Workflow Builders & Low-Code Platforms](#-workflow-builders--low-code-platforms)
- [🎓 Education & Learning Agents](#-education--learning-agents)
- [🏥 Healthcare & Medical Agents](#-healthcare--medical-agents)
- [💬 Communication & Collaboration Agents](#-communication--collaboration-agents)
- [🔬 Research & Academic Agents](#-research--academic-agents)
- [🧪 Science & Discovery Agents](#-science--discovery-agents)
- [🌍 Personal Productivity Agents](#-personal-productivity--life-management-agents)
- [💼 HR & Recruitment Agents](#-hr--recruitment-agents)
...
## 📈 GitHub Stars Rankings

### Top Projects by Stars (April 2026)

```
AutoGPT                    ██████████████████████████████████████████████████ 170,000+ ⭐
LangChain                  ████████████████████████████████████████████████   105,000+ ⭐
Open Interpreter           ████████████████████████████████████████████████    58,000+ ⭐
Cline                      ██████████████████████████████████████████████      55,000+ ⭐
CrewAI                     █████████████████████████████████████████████       35,000+ ⭐
Aider                      ████████████████████████████████████████████        30,000+ ⭐
AgentGPT                   ███████████████████████████████████████████         31,000+ ⭐
LangGraph                  ██████████████████████████████████                  17,000+ ⭐
Microsoft Semantic Kernel  █████████████████████████████████                   23,000+ ⭐
Continue                   ████████████████████████████████                    22,000+ ⭐
Baby AGI                   ████████████████████████████████                    20,000+ ⭐
GPT Researcher             ██████████████████████████                          15,000+ ⭐
OpenAI Agents SDK          ██████████████████████                              14,000+ ⭐
Goose (Block)              ████████████████                                     10,000+ ⭐
Phidata                    ████████████████                                      9,000+ ⭐
PR-Agent                   ██████████                                            6,000+ ⭐
```
...
```
Browser / Computer Use Agents    ████████████████████████████████████████ 48% 🔥
...
## 🆕 Fresh Arrivals — Q1/Q2 2026

> The most significant new autonomous tools, agents, and models entering the market in early 2026.
...
- **[AgentGPT](https://github.com/reworkd/AgentGPT)** `MIT · 31k ⭐` — Browser-based autonomous AI agents — define a goal, deploy an agent, and watch it execute step by step.
- **[Chrome Extension AI Agents](https://github.com/various)** `Various` — Growing open-source ecosystem of Chrome extensions enabling AI-powered web automation without a backend.

---

## 🧠 Reasoning & Foundation Models

- **[Claude 4.6 (Opus & Sonnet)](https://claude.ai)** `🔥 Proprietary · Feb 2026` — Anthropic's current frontier. 1M token context, parallel sub-agents, SWE-bench #1. See [Fresh Arrivals](#-fresh-arrivals--q1q2-2026).
- **[GPT-5.4 Family](https://openai.com)** `🔥 Proprietary · Mar 2026` — OpenAI's frontier with adaptive thinking modes. GPT-4o deprecated April 2026. See [Fresh Arrivals](#-fresh-arrivals--q1q2-2026).
- **[Gemini 3.1 Pro](https://gemini.google.com)** `🆕 Proprietary · 2026` — Google's current flagship multimodal model, superseding Gemini 2.5 Pro. See [Fresh Arrivals](#-fresh-arrivals--q1q2-2026).
- **[DeepSeek-R1](https://github.com/deepseek-ai/DeepSeek-R1)** `Open Source · $6M training` — Open-source reasoning model that disrupted LLM pricing. Downloaded globally at rates exceeding major US models.
- **[AM-Thinking-v1](https://huggingface.co)** `Open Source` — Dense 32B reasoning model built on Qwen2.5-32B. Strong reasoning capabilities at accessible compute cost.
...
- **[Runway Gen-3 Alpha & GWM-1](https://runwayml.com)** `Commercial` — Advanced AI video generation with the new GWM-1 world model for long-form, coherent video synthesis.
- **[Synthesia AI Avatars](https://synthesia.io)** `Commercial` — AI-powered video creation with hyper-realistic virtual presenters and customizable avatars.
- **[MidJourney Agent](https://midjourney.com)** `Commercial` — State-of-the-art AI art and image generation with precise style control and photorealism.
- **[ElevenLabs Voice Agents](https://elevenlabs.io)** `Commercial` — AI voice cloning and speech synthesis — 29+ languages, 1-minute voice cloning, emotional range control.

---

## 📊 Data & Analytics Agents

- **[DataRobot Autonomous AI](https://datarobot.com)** `Commercial` — End-to-end automated machine learning: model building, deployment, monitoring, and governance.
- **[Tableau Ask Data](https://tableau.com)** `Commercial` — Natural language interface for business intelligence — ask questions in plain English, get instant visualizations.
- **[Power BI Copilot](https://powerbi.microsoft.com)** `Commercial` — Microsoft's AI assistant for business intelligence — report generation, insight discovery, and data Q&A.
...
### ⚖️ Legal
- **[Thomson Reuters CoCounsel](https://legal.thomsonreuters.com/cocounsel):** Agentic workflows for legal work and document review.
- **[Harvey AI](https://harvey.ai):** Legal AI for research, drafting, and contract analysis.
- **[LexisNexis Legal Agents](https://lexisnexis.com):** Legal research and case analysis agents.
- **[Steno](https://steno.com):** `🆕 $49M` Litigation AI for court reporting and deposition prep.

### 🏥 Healthcare
- **[K Health](https://khealth.com):** AI diagnosis integrated with Mass General Brigham and Mayo Clinic.
- **[AlethianAI](https://alethianai.com):** Medical coding and clinical documentation.
- **[UpToDate Expert AI](https://uptodate.com):** Clinical decision support powered by GenAI.
- **[Epic/Cerner AI](https://epic.com):** EHR documentation automation accepted by CMS.

### 💰 Finance & Accounting
- **[Big Four Accounting Agents](https://pwc.com):** PwC, KPMG, Deloitte, EY autonomous audit and compliance systems.
- **[Variance](https://variance.com):** `🆕 $21.5M` Automated compliance and risk workflow agents.
- **[Fraud Detection Agents](https://darktrace.com):** Real-time autonomous financial fraud monitoring.

### 🛍️ Retail
- **[Microsoft Retail Suite](https://microsoft.com/retail):** End-to-end retail automation from inventory to customer engagement.
- **[Google Business Agent](https://business.google.com):** Customer service for Lowe's, Michael's, Poshmark, Reebok.
- **[UCP-Connected Agents](https://developers.google.com/shopping):** Discovery, inventory lookup, and autonomous purchase agents.
...
| Period | Milestone |
|--------|-----------|
| Jan 2025 | DeepSeek-R1 disrupted the industry — $6M open-source model set new cost benchmarks |
| Apr 2025 | Google A2A Protocol launched · Anthropic MCP became the infrastructure standard |
| Mid 2025 | Agentic browsers emerged (Perplexity Comet, Opera Neon) · n8n lowered barriers |
| Nov 2025 | Claude Code misuse incident triggered industry-wide agent safety focus |
| Late 2025 | Big Four firms launched agent systems · Linux Foundation created Agentic AI Foundation |

### 📊 2025 Growth Stats

| Metric | Value |
|--------|-------|
| CrewAI GitHub Stars Growth | +800% |
| Phidata GitHub Stars Growth | +450% |
| OpenAI Agents SDK Stars Growth | +300% |
| LangChain Monthly Downloads | 28M |
| Enterprise agentic AI investments | 42% of enterprises |

### 🎯 Defining Trends of 2025

1. **Browser Automation** became the dominant use case
2. **MCP Protocol** emerged as the "USB-C for AI"
3. **Multi-Agent Systems** moved from demos to production
4. **Security Concerns** escalated significantly
5. **Open Source** accelerated with DeepSeek-R1
...
- ✅ Universal Commerce Protocol adoption accelerated
- ✅ Security governance became mandatory focus
- ✅ Claude Cowork launched — file management agents arrived
- ✅ GitHub Copilot agentic code review reached GA
- ✅ A2A Protocol v1.0 officially released
- ✅ GPT-5.4 released — GPT-4o deprecated

### 🔄 Q2–Q4 2026 — In Progress

- 🔄 Agent-to-agent communication becomes standard practice
- 🔄 80% of enterprise apps to have integrated agents (Gartner)
- 🔄 EU AI Act high-risk requirements in force (August 2026)
- 🔄 "Lonely agents" problem addressed with better orchestration
- 🔄 VLA models (NVIDIA Alpamayo) enable first mass-market physical AI
- 🔄 MCP + A2A as ubiquitous as REST APIs

### 🚨 Key Challenges

- **Security & Trust** — top concern across all enterprise deployments
- **Governance Gap** — 80% deploying without proper governance frameworks
- **Agent Sprawl** — hundreds of agents per employee, most idle
- **Interoperability** — fragmented ecosystems, competing standards
- **Regulatory Compliance** — EU AI Act, sector-specific rules

### 💰 Key Opportunities

- **Enterprise adoption wave** — 40–80% app integration by EOY
- **Physical AI** — robots guided by frontier-scale reasoning
- **Agentic commerce** — UCP + A2A transforming how people shop
- **AI security market** — projected $800B–$1.2T by 2031
- **Vertical AI agents** — high-value, domain-specific automation in law, medicine, finance

---

## 🤝 Contributing

Want to add a new AI agent or tool? It must meet these criteria:

- ✅ Autonomous or semi-autonomous functionality
- ✅ Active development (updated in 2025–2026)
- ✅ Open source or significant free tier available
- ✅ Practical use cases with good documentation
- ✅ Community traction (GitHub stars, forks, or verified commercial adoption)

**Steps:**
1. Fork this repository
2. Add your tool to the appropriate category using the bullet format: `- **[Name](link)** \`License\` — Description.`
3. Submit a pull request with a clear description
4. Ensure all links are active and information is verifiable

---

## 📞 Community

- **GitHub Issues** — Report errors or suggest additions
- **Discussions** — Share use cases and best practices
- **Twitter/X** — Follow `#AgenticAI` and `#AIAgents`
...
Community-curated list. Information is accurate as of **April 9, 2026** but evolves rapidly. Always verify on official websites before making decisions. Some agents have usage restrictions or compliance requirements.

---

*Last Updated: April 9, 2026 · Maintained by the community · PRs welcome!*